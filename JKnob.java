...
class JKnob extends JComponent implements MouseListener, MouseMotionListener {
    ...
    /**
     * Constructor that initializes the position of the knob to the specified angle
     * in radians.
     *
    ...
    /**
     * Paint the JKnob on the graphics context given. The knob is a filled circle
     * with a small filled circle offset within it to show the current angular
    ...
    /**
     * Return the minimum size that the knob would like to be. This is the same size
     * as the preferred size so the knob will be of a fixed size.
     *
    ...
    /**
     * Determine if the mouse click was on the spot or not. If it was return true,
    ...
    /**
     * When the mouse button is pressed, the dragging of the spot will be enabled if
     * the button was pressed over the spot.
     *
 ...
 * JKnob" then this main() method will be run. However, if another file uses a
 * JKnob as a component and that file is run then this main is ignored.
 */
